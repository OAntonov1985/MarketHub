...
export default function Authorization() {
    ...
    const [displaySecondPassField, setDisplaySecondPassField] = useState('none');
    ...
    const toggleTemp = () => {
        ...
        setDisplaySecondPassField(displaySecondPassField => (displaySecondPassField === 'none' ? 'flex' : 'none'));
    };
        ...
        <>
            <div className="sing__in__wondow flex">
                <div className="sing__in__left__column">
                    ...
                    <form action="" method='POST' className='login__form' onSubmit={(event) => GetInputInfo(event, router, singInText)}>
                        ...
                        <div className='left__column__row__three input__row' style={{ 'display': displaySecondPassField }}>
                            <label htmlFor="confirm__password" className='label confirm__password'>Confirm  Password</label>
                            <input type={typeInput}
                                className='input__password input__log confirm__password'
                                minLength={7}
                                placeholder='Confirm your password'
                                required={singInText === 'Sign in' ? false : true}
                            />
                    ...
                    <div className='looser__button' style={{ 'display': displaySecondPassField === "flex" ? "none" : "flex" }} >
                        <Link href="/">
